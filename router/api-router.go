	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/aff_rewards", controller.GetAffiliateRewards)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/aff_rewards/admin", controller.GetAdminAffiliateRewards)
				adminRoute.POST("/aff_rewards/:id/void", controller.VoidAffiliateReward)
